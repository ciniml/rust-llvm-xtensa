...
public:
  ...
  unsigned InsertBranchAtInst(MachineBasicBlock &MBB, MachineBasicBlock::iterator I,
  ...
  bool isBranch(const MachineBasicBlock::iterator &MI, SmallVectorImpl<MachineOperand> &Cond,
